      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <router-link to="/bets/place" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <span class="ml-3">Place a Bet</span>
          </router-link>
        </li>
      </ul>
    </div>
